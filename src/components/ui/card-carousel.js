  ...
  return (
    <>
      ...
      <motion.button
        layoutId={layout ? `card-${card.title}` : undefined}
        // onClick={handleOpen}
        className="relative z-10 flex h-10 w-40 flex-col items-start justify-start overflow-hidden rounded-3xl bg-gray-100 md:h-[36rem] md:w-96 dark:bg-neutral-900">
        <div

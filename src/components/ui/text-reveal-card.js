...
export const TextRevealCard = ({
  ...
  return (
    <div
      ...
      ref={cardRef}
      className={cn(
        "bg-transparent w-[48rem] h-[15rem] rounded-lg p-8 relative ",
        className
      )}>
      {children}
      <div className="h-40 overflow-hidden relative flex items-center">
        <motion.div
          ...
          <p
            ...
            className="text-base text-center sm:text-[3rem] py-10 
            font-bold bg-clip-text rounded-lg p-2 border border-white/[0.08]
            text-transparent bg-gradient-to-b from-white to-neutral-300">
            {revealText}
          </p>
        </motion.div>
        <motion.div
        ...
        <div
          ...
          <p
            className="text-base text-center sm:text-[3rem] py-10 font-bold bg-clip-text text-transparent bg-white">
            {text}
          </p>
          <MemoizedStars className = "relative w-full h-full"/>
        </div>
      </div>
    </div>
  );
...
export const TextRevealCardTitle = ({
  ...
  return (
    <h2 className={twMerge("text-neutral-200 text-lg mb-2", className)}>
      {children}
    </h2>
  );
};
